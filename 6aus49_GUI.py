...
Button(tastenframe, text=10, padx=15, pady=20, height=1, width=1, command=lambda: button_click(10)).grid(row=1, column=5)
Button(tastenframe, text=11, padx=15, pady=20, height=1, width=1, command=lambda: button_click(11)).grid(row=2, column=1)
Button(tastenframe, text=12, padx=15, pady=20, height=1, width=1, command=lambda: button_click(12)).grid(row=2, column=2)
Button(tastenframe, text=13, padx=15, pady=20, height=1, width=1, command=lambda: button_click(13)).grid(row=2, column=3)
Button(tastenframe, text=14, padx=15, pady=20, height=1, width=1, command=lambda: button_click(14)).grid(row=2, column=4)
Button(tastenframe, text=15, padx=15, pady=20, height=1, width=1, command=lambda: button_click(15)).grid(row=2, column=5)
...
Button(tastenframe, text=23, padx=15, pady=20, height=1, width=1, command=lambda: button_click(23)).grid(row=4, column=3)
Button(tastenframe, text=24, padx=15, pady=20, height=1, width=1, command=lambda: button_click(24)).grid(row=4, column=4)
Button(tastenframe, text=25, padx=15, pady=20, height=1, width=1, command=lambda: button_click(25)).grid(row=4, column=5)
Button(tastenframe, text=26, padx=15, pady=20, height=1, width=1, command=lambda: button_click(26)).grid(row=5, column=1)
Button(tastenframe, text=27, padx=15, pady=20, height=1, width=1, command=lambda: button_click(27)).grid(row=5, column=2)
Button(tastenframe, text=28, padx=15, pady=20, height=1, width=1, command=lambda: button_click(28)).grid(row=5, column=3)
Button(tastenframe, text=29, padx=15, pady=20, height=1, width=1, command=lambda: button_click(29)).grid(row=5, column=4)
Button(tastenframe, text=30, padx=15, pady=20, height=1, width=1, command=lambda: button_click(30)).grid(row=5, column=5)
Button(tastenframe, text=31, padx=15, pady=20, height=1, width=1, command=lambda: button_click(31)).grid(row=6, column=1)
Button(tastenframe, text=32, padx=15, pady=20, height=1, width=1, command=lambda: button_click(32)).grid(row=6, column=2)
Button(tastenframe, text=33, padx=15, pady=20, height=1, width=1, command=lambda: button_click(33)).grid(row=6, column=3)
Button(tastenframe, text=34, padx=15, pady=20, height=1, width=1, command=lambda: button_click(34)).grid(row=6, column=4)
Button(tastenframe, text=35, padx=15, pady=20, height=1, width=1, command=lambda: button_click(35)).grid(row=6, column=5)
Button(tastenframe, text=36, padx=15, pady=20, height=1, width=1, command=lambda: button_click(36)).grid(row=7, column=1)
Button(tastenframe, text=37, padx=15, pady=20, height=1, width=1, command=lambda: button_click(37)).grid(row=7, column=2)
Button(tastenframe, text=38, padx=15, pady=20, height=1, width=1, command=lambda: button_click(38)).grid(row=7, column=3)
Button(tastenframe, text=39, padx=15, pady=20, height=1, width=1, command=lambda: button_click(39)).grid(row=7, column=4)
Button(tastenframe, text=40, padx=15, pady=20, height=1, width=1, command=lambda: button_click(40)).grid(row=7, column=5)
Button(tastenframe, text=41, padx=15, pady=20, height=1, width=1, command=lambda: button_click(41)).grid(row=8, column=1)
Button(tastenframe, text=42, padx=15, pady=20, height=1, width=1, command=lambda: button_click(42)).grid(row=8, column=2)
Button(tastenframe, text=43, padx=15, pady=20, height=1, width=1, command=lambda: button_click(43)).grid(row=8, column=3)
Button(tastenframe, text=44, padx=15, pady=20, height=1, width=1, command=lambda: button_click(44)).grid(row=8, column=4)
Button(tastenframe, text=45, padx=15, pady=20, height=1, width=1, command=lambda: button_click(45)).grid(row=8, column=5)
Button(tastenframe, text=46, padx=15, pady=20, height=1, width=1, command=lambda: button_click(46)).grid(row=9, column=1)
Button(tastenframe, text=47, padx=15, pady=20, height=1, width=1, command=lambda: button_click(47)).grid(row=9, column=2)
Button(tastenframe, text=48, padx=15, pady=20, height=1, width=1, command=lambda: button_click(48)).grid(row=9, column=3)
Button(tastenframe, text=49, padx=15, pady=20, height=1, width=1, command=lambda: button_click(49)).grid(row=9, column=4)
